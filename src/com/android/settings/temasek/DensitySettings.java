...
public class DensitySettings extends SettingsPreferenceFragment {
    ...
    private static int mDefaultDensity = getDefaultDensity();
    ...
    private void updateSettings() {
        ...
        addPreferencesFromResource(R.xml.density_settings);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        DensitySettings getOwner() {
            return (DensitySettings) getTargetFragment();
        }
